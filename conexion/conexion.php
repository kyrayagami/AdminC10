<?php 
		class Conexion{
			...
			/*	$this->$host='localhost';
				$this->$user='root';
				$this->pw='123456';
				$this->db='promo_vision2';*/

				$this->ruta="localhost"; //
				$this->usuario="root"; //usuario que tengas definido
				$this->contrasena="123456"; //contraseña que tengas definidad
				$this->baseDatos="promo_vision2"; //base de datos personas, si quieres utilizar otra base de datos solamente cambiala
			}
